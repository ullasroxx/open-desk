      ...
      <div className="flex-1 glass-card flex flex-col overflow-hidden relative">
        ...
        <div className="p-4 border-b border-border-default flex items-center justify-between bg-bg-secondary/30">
          ...
          <div className="flex items-center gap-2">
            <button className="px-3 py-1.5 rounded-lg bg-bg-hover text-xs font-medium text-text-secondary hover:text-text-primary transition-colors border border-border-default">
              Clear Context
            </button>
          </div>
        </div>
        ...
        <div className="p-4 bg-bg-secondary/50 border-t border-border-default">
          <div className="relative flex items-center">
            <button className="absolute left-3 text-text-muted hover:text-accent-blue transition-colors">
            ...
            />
            <button className="absolute right-2 p-2 rounded-lg bg-gradient-to-r from-accent-blue to-accent-cyan text-white shadow-md hover:opacity-90 transition-opacity">
